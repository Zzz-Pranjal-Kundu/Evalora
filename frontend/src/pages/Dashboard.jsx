    ...
    <div className="page page--home">
      {accessNotice && (
        <div className="alert alert-error" style={{ display: "flex", justifyContent: "space-between", gap: "1rem" }}>
          <span>
            That area is restricted for your role. Use the menu to open pages your organization assigned to you.
          </span>
      ...
      {loading ? (
        ...
        <>
          <div className="dash-hero-grid">
            <div className="dash-welcome">
              <div className="dash-welcome__body">
                <h1 className="dash-welcome__title">Welcome back, {displayName} 👋</h1>
                ...
                <div className="dash-welcome__chips">
                  <span className="dash-welcome__chip dash-welcome__chip--cycle">
                    <span className="topbar__chip-dot topbar__chip-dot--live" style={{ marginRight: 4 }} />
                    Cycle: {activeCycle ? "Active" : "Awaiting"}
                  </span>
                  <span className="dash-welcome__chip dash-welcome__chip--role">Role: {role || "Employee"}</span>
                  <span className="dash-welcome__chip dash-welcome__chip--ws">Workspace: EPFMS Core</span>
                </div>
              </div>
                ...
                <svg viewBox="0 0 120 100" width="120" height="100">
                  <defs>
                    <linearGradient id="m1" x1="0%" y1="100%" x2="100%" y2="0%">
                      ...
                      <stop offset="100%" stopColor="#36cfc9" stopOpacity="0.5" />
                    </linearGradient>
                  </defs>
                  <path d="M10 85 L35 45 L55 60 L80 25 L110 85 Z" fill="url(#m1)" stroke="#1677ff" strokeWidth="1.5" opacity="0.9" />
                  <rect x="52" y="18" width="4" height="22" fill="#d46b08" rx="1" />
            ...
            <div className="dash-glance">
              ...
              <div className="dash-glance__grid">
                <Link to="/feedback" className="dash-glance__tile">
                  ...
                  <div className="dash-glance__sub">Requests in your workspace</div>
                </Link>
                ...
                <Link to="/notifications" className="dash-glance__tile">
                  ...
                  <div className="dash-glance__sub">Unread-friendly snapshot</div>
                </Link>
          ...
          <div className="epfms-pillar-grid card" style={{ marginBottom: "1.5rem" }}>
            <h2 className="epfms-pillar-grid__title">What this platform covers</h2>
            <p className="muted epfms-pillar-grid__lead">
              Employees see feedback and self-assessments; managers monitor progress and run appraisals; HR uses analytics
              for adoption and talent decisions.
            </p>
          ...
          <div
            className={`dash-org-activity-row${orgSnapshot.headcount > 0 ? " dash-org-activity-row--with-org" : ""}`}
          >
            {orgSnapshot.headcount > 0 && (
              <div className="card" style={{ marginBottom: 0 }}>
                ...
                <p className="muted" style={{ marginTop: 0 }}>
                  Departments and squads in view: <strong>{orgSnapshot.headcount}</strong> people
                  {orgSnapshot.directReports.length > 0 ? (
                    <>
                      {" "}
                      · Your direct reports: <strong>{orgSnapshot.directReports.length}</strong>
                    </>
                  ) : null}
                  .
                </p>
          ...
          {activeCycle && (
            <div className="dashboard-hero card">
              <div className="dashboard-hero__top">
                <div>
                  <p className="dashboard-hero__eyebrow">
                    <CalendarRange size={16} aria-hidden style={{ verticalAlign: "text-bottom", marginRight: 6 }} />
                    Active review cycle
                  </p>
                  ...
                  <p className="muted" style={{ margin: "0.35rem 0 0" }}>
                    ...
                    <span className={`badge ${activeCycle.status === "ACTIVE" ? "badge--active" : "badge--muted"}`} style={{ marginLeft: "0.5rem" }}>
                      {activeCycle.status}
                    </span>
                  </p>
                </div>
              ...
              <p className="muted" style={{ margin: "0.85rem 0 0", fontSize: "0.9rem" }}>
                Formal ratings, narrative summaries, and calibration packets for this cycle are coordinated from{" "}
                <strong>Reviews</strong> and <strong>Feedback</strong>. Development plans support the same story through the
                year.
              </p>
            </div>
          )}
          ...
          {!activeCycle && (
            <div className="card" style={{ marginBottom: "1.25rem", borderStyle: "dashed" }}>
              <h2 className="dashboard-hero__title" style={{ fontSize: "1.05rem" }}>
                No review cycle on file yet
              </h2>
              <p className="muted" style={{ margin: 0 }}>
                When HR publishes a cycle, dates and status will appear here. You can still capture informal feedback anytime.
              </p>
            </div>
          )}
          ...
          {managerDash && (
            <div className="card dashboard-role-card">
              ...
              <ul className="dashboard-kpi-list">
                <li>
                  <strong>{managerDash.pendingReviews ?? "—"}</strong> pending team reviews (placeholder)
                </li>
              </ul>
          ...
          {hrDash && (
            <div className="card dashboard-role-card">
              ...
              <ul className="dashboard-kpi-list">
                <li>
                  <strong>{hrDash.activeCycles ?? "—"}</strong> active cycles (placeholder)
                </li>
                <li>
                  <strong>{hrDash.calibrationSessions ?? "—"}</strong> calibration sessions (placeholder)
                </li>
              </ul>
              <div style={{ marginTop: "1rem", display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
          ...
          {leadershipDash && (
            <div className="card dashboard-role-card">
              <h2>
                <LineChart size={20} style={{ display: "inline", verticalAlign: "text-bottom", marginRight: 8 }} />
                Leadership view
              </h2>
          ...
          {role === "EMPLOYEE" && (
            <div className="card" style={{ borderLeft: "4px solid var(--color-accent)" }}>
              ...
              <p className="muted" style={{ margin: 0 }}>
                Organization charts, calibration sessions, HR configuration, and org-wide analytics are reserved for managers
                and HR. If you need access, ask your HR business partner to update your role in the directory.
              </p>
            </div>
          )}
        </>
